...
```
https://tut-syllabus-api.pages.dev/api/v1/archive/{年度}/all/{時間割コード}.json
https://tut-syllabus-api.pages.dev/api/v1/archive/{年度}/{学部名}/{時間割コード}.json
```
...
```
https://tut-syllabus-api.pages.dev/api/v1/index.json
https://tut-syllabus-api.pages.dev/api/v1/archive/{年度}/index.json
```

曜日は `{曜日キー}` に `mon`, `tue`, `wed`, `thu`, `fri`, `sat`, `sun`, `other` を指定します。

```
https://tut-syllabus-api.pages.dev/api/v1/index/weekday/{曜日キー}.json
https://tut-syllabus-api.pages.dev/api/v1/archive/{年度}/index/weekday/{曜日キー}.json
```

時限は `{時限}` に `1`, `2`, `3`, ... または `other` を指定します。

```
https://tut-syllabus-api.pages.dev/api/v1/index/period/{時限}.json
https://tut-syllabus-api.pages.dev/api/v1/archive/{年度}/index/period/{時限}.json
```

曜日と時限の組み合わせは `{曜日時限キー}` に `mon-1`, `wed-2`, `fri-5`, `other` などを指定します。

```
https://tut-syllabus-api.pages.dev/api/v1/index/class-period/{曜日時限キー}.json
https://tut-syllabus-api.pages.dev/api/v1/archive/{年度}/index/class-period/{曜日時限キー}.json
```

`regularOrIntensive` は日本語文字列が長いため、`index.json` の `regularOrIntensive[].key` を指定します。

```
https://tut-syllabus-api.pages.dev/api/v1/index/regularOrIntensive/{regularOrIntensiveキー}.json
https://tut-syllabus-api.pages.dev/api/v1/archive/{年度}/index/regularOrIntensive/{regularOrIntensiveキー}.json
```

教員名は `index.json` の `lecturer[].key` を指定します。

```
https://tut-syllabus-api.pages.dev/api/v1/index/lecturer/{教員キー}.json
https://tut-syllabus-api.pages.dev/api/v1/archive/{年度}/index/lecturer/{教員キー}.json
```

開講時期は `index.json` の `courseStart[].key` を指定します。通常は `2026-first` が `2026年度前期`、`2026-second` が `2026年度後期` です。

```
https://tut-syllabus-api.pages.dev/api/v1/index/course-start/{開講時期キー}.json
https://tut-syllabus-api.pages.dev/api/v1/archive/{年度}/index/course-start/{開講時期キー}.json
```

対象学年は `index.json` の `targetGrade[].key` を指定します。通常は `1`, `2`, `3`, `4` です。

```
https://tut-syllabus-api.pages.dev/api/v1/index/target-grade/{対象学年キー}.json
https://tut-syllabus-api.pages.dev/api/v1/archive/{年度}/index/target-grade/{対象学年キー}.json
```

科目区分は `index.json` の `courseType[].key` を指定します。

```
https://tut-syllabus-api.pages.dev/api/v1/index/course-type/{科目区分キー}.json
https://tut-syllabus-api.pages.dev/api/v1/archive/{年度}/index/course-type/{科目区分キー}.json
```
...
```
https://tut-syllabus-api.pages.dev/api/v1/search-index/{学部名}.json
https://tut-syllabus-api.pages.dev/api/v1/archive/{年度}/search-index/{学部名}.json
```
